### JS++ jQuery Drag & Drop (with Modules)

This example demonstrates drag & drop using jQuery. This example also uses
...
In order to compile this particular example, use the following command:
    ...
    js++ src/main.jspp src/DragAndDrop.jspp src/JQuery.jspp -o compiled/main.jspp.js
