### JS++ jQuery Animation (with Modules)

This example demonstrates animation using jQuery. This example also uses
...
In order to compile this particular example, use the following command:
    ...
    js++ src/main.jspp src/Bounce.jspp src/JQuery.jspp -o compiled/main.jspp.js
